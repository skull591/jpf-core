...
//  }
  ...
  public ElementInfo newElementInfo (ClassInfo ci) throws ClinitRequired {
	//temp solution...obviously
   // if (ci.initializeClass(ti) && !ci.name.equals("android.widget.Button") && !ci.name.equals("android.view.MenuInflater")){
 ...
 //   System.out.println("the name+"+clsName);
	ClassInfo ci = ClassLoaderInfo.getCurrentResolvedClassInfo(clsName);
	//System.out.println("the name+"+clsName);
    if (ci != null){
