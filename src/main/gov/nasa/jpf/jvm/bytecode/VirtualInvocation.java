...
public abstract class VirtualInvocation extends InstanceInvocation {
  ...
  public Instruction execute (ThreadInfo ti) {
	/*if(mname.equals("checkCallingOrSelfPermission(Ljava/lang/String;)I")){
		System.out.println("VirtualInvocation:"+cname+"."+mname+" "+getArgSize());
	}*/
    int objRef = ti.getCalleeThis(getArgSize());
    /*if(mname.equals("checkCallingOrSelfPermission(Ljava/lang/String;)I")){
    	  System.out.println("VirtualInvocation: "+objRef);
  		}*/
    MethodInfo callee;

    if (objRef == MJIEnv.NULL) {
    	 /*if(mname.equals("checkCallingOrSelfPermission(Ljava/lang/String;)I")){
       	  System.out.println("VirtualInvocation: NULL");
     		}*/
      lastObj = MJIEnv.NULL;
    ...
    try {
    	/*if(mname.equals("checkCallingOrSelfPermission(Ljava/lang/String;)I")){
      	  System.out.println("VirtualInvocation: getInvokeMethod");
    		}*/
      callee = getInvokedMethod(ti, objRef);
      /*if(mname.equals("checkCallingOrSelfPermission(Ljava/lang/String;)I")){
    	  System.out.println("VirtualInvocation: "+callee.getFullName());
  		}*/   
    ...
    if (callee == null) {
      ...
      if (callee.isAbstract()){
    	  /*if(mname.equals("checkCallingOrSelfPermission(Ljava/lang/String;)I")){
        	  System.out.println("VirtualInvocation: Abstract?!");
      		}*/   
